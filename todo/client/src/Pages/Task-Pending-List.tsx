...
export default function TaskPendingList() {
  ...
  const testProps: TpendingTaskProps = {
    ...
    taskName: ["Test Task"],
    taskDeadline: [new Date("2024-12-25")],
    taskDescription: ["xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"],
  };
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-background-color-main pt-[5px] flex flex-col">
        <div className="grid grid-cols-2 grid-rows-2 gap-4 justify-items-center py-4">
          <PendingForm
            taskImage={testProps["taskImage"]}
            taskName={testProps["taskName"]}
            taskDeadline={testProps["taskDeadline"]}
            taskDescription={testProps["taskDescription"]}
          />
          <PendingForm
            taskImage={testProps["taskImage"]}
            taskName={testProps["taskName"]}
